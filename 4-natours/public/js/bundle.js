...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Add the marker
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Welcome to Natours Family. Kindly Check your email.');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_51HXPHVF1X065rUCbo8Q6BbkRWp7PkCjkZALqnKpQjRKKKgW9OsfEgcCh18x1c26IBZRNEjGHngtWit1T7wG8E7m900ZLzhN0mZ');
...
var signupBtn = document.getElementById('btn--signup'); //Delegation
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault(); //LOGIN PARAMETERS
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...'; // note: the data attribute on the btn is 'tour-1d'. It would definitely auto concartinated and in camel case, else, tourId is achievable
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2226" + '/');
